...
# Welcome subtitle
st.markdown("""
    <div style='text-align: center; font-size: 22px; font-weight: bold; padding-top: 10px; margin-bottom: 25px; color: skyblue;'>
        Welcome to the Electric Vehicle (EV) Adoption Forecast tool.
    </div>
""", unsafe_allow_html=True)

# Image
st.image("1img.jpg", use_container_width=True)
...
st.markdown("""
            ...
            Prepared for the **AICTE Internship Cycle 2 by S4F on the topic of EV Data**
